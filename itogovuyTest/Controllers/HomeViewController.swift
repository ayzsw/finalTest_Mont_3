...
class HomeViewController: UIViewController {
    ...
    private let categoriesCollectionView: UICollectionView = {
        ...
        categoriesCV.backgroundColor = Color2.mainGrey
    ...
    private let productTabelView: UITableView = {
        let tableView = UITableView()
        tableView.backgroundColor = Color2.mainGrey
        return tableView
    }()
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = Color2.mainGrey
...
extension HomeViewController: UISearchBarDelegate {
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText.isEmpty {
            ...
            isFiltr = true
            filtrList = productsList.filter {
                $0.nameProduct.contains(searchText)
            }
